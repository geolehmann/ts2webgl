...
<br><br><b><u>Objekte:</u></b><br><br>\
	...
	for (int i = 0; i < objects.size(); i++)
	{
		...
		{
			description = " <img height='20' width='20' src='data:image/png;base64,'></img> " + objects.at(i).name + " <div style='width:20px;height:10px;border:1px; background-color:" + rgbToHex(objects.at(i).color) + "; display: inline-block;'></div> <br>";
		}
